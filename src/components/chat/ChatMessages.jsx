    ...
    return (
        ...
        >
            ...
            {messages.map((msg, idx) => {
                ...
                const parts = parseMessageContent(msg.content || msg.message_content);
                ...
                return (
                    ...
                    >
                        ...
                        <div
                            className={`max-w-xs lg:max-w-md rounded-2xl px-4 py-3 text-white shadow-lg ${isOwn
                                ? 'bg-red-800/60'
                                : 'bg-slate-800/60'
                                    ...
                                    {Object.entries(msg.reaction_emojis).map(([emoji, users]) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`px-2 py-1 rounded text-sm transition duration-300 ${userHasReacted
