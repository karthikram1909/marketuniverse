...
export default function VIPPoolAdmin() {
    ...
    const createTradeMutation = useMutation({
        mutationFn: async (tradeData) => {
            ...
            // Admin notification
            notifications.push({
                type: 'admin_vip_deposit',
                title: 'Trade Added to VIP Pool',
    ...
    return (
        <div className="min-h-screen bg-black relative overflow-hidden">
                ...
                {!poolSettings && (
                    ...
                    >
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <h3 className="text-3xl font-bold text-white mb-4">VIP Pool Not Initialized</h3>
                            ...
                            >
                                {createPoolSettingsMutation.isPending ? 'Initializing...' : '🚀 Initialize VIP Pool'}
                            </Button>
                        </div>
                    </motion.div>
                )}
                ...
                {poolSettings && (
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="grid md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    <label className="text-sm text-gray-400 mb-2 block">Minimum Deposit (USDT)</label>
                                    <Input
                                        type="number"
                                        step="1"
                                        value={poolSettings.min_deposit_amount || 0}
                                        onChange={(e) => {
                                            updatePoolSettingsMutation.mutate({ min_deposit_amount: parseFloat(e.target.value) || 0 });
                                        }}
                                        className="bg-white/5 border-white/10 text-white"
                                        placeholder="0"
                                    />
                                ...
                                <div>
                                    <label className="text-sm text-gray-400 mb-2 block">Maximum Deposit (USDT)</label>
                                    <Input
                                        type="number"
                                        step="1"
                                        value={poolSettings.max_deposit_amount || ''}
                                        onChange={(e) => {
                                            const val = e.target.value ? parseFloat(e.target.value) : null;
                                            updatePoolSettingsMutation.mutate({ max_deposit_amount: val });
                                        }}
                                        className="bg-white/5 border-white/10 text-white"
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody>
                                    {(() => {
                                        ...
                                        return [
                                            ...rows,
                                            <tr key="totals" className="border-t-2 border-purple-500/30 bg-purple-500/5">
            ...
            <SuccessModal
                ...
                title="Success!"
                message="VIP Pool database has been reset successfully!"
            />
