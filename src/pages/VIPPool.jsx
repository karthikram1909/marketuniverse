        ...
        try {
            await Promise.all([
                supabase.from('notifications').insert({
                    wallet_address: walletAddr,
                    email: formData.email,
                    type: 'vip_withdrawal_request',
                    title: 'VIP Pool Withdrawal Requested',
                ...
                supabase.from('notifications').insert({
                    wallet_address: walletAddr,
                    email: formData.email,
                    type: 'admin_vip_withdrawal_request',
                    title: 'New VIP Pool Withdrawal Request',
                    message: `${formData.name_surname} has requested a withdrawal of ${formData.amount} USDT from VIP Pool.`,
                    amount: parseFloat(formData.amount),
                    read: false,
                    is_admin: true
                })
            ...
            <div className="relative z-10 px-4 sm:px-6 py-8 max-w-7xl mx-auto w-full">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        {user?.role === 'admin' && (
                            <Link to={createPageUrl('VIPPoolAdmin')} className="self-start sm:self-auto">
                ...
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-black/60 border border-purple-500/30 rounded-2xl p-6 sm:p-8 backdrop-blur-xl mb-8"
                >
                    <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 flex items-center gap-3">
                        <Shield className="w-7 h-7 text-purple-400" />
                        How VIP Pool Works
                    </h2>
                    <p className="text-purple-400 text-base sm:text-lg mb-8">Understanding the mechanics and profit distribution</p>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="border-l-4 border-cyan-500 pl-6">
                            ...
                            <div className="text-gray-300 space-y-3">
                                <p>Elite traders manage collective funds using premium multi-strategy approaches: scalping, swing trading, and position trading combined. Your ownership percentage determines your share of profits and losses.</p>
                                <div className="bg-white/5 rounded-xl p-4">
                                    <p className="text-cyan-400 font-semibold mb-2">Key Features:</p>
                                    <ul className="space-y-1 text-sm">
                                        <li>• No lock-in period – withdraw anytime</li>
                                        <li>• Multi-strategy advanced trading</li>
                                        <li>• Minimum deposit: $20,000 USDT</li>
                                        <li>• Lower profit share: 10% (vs 20% in other pools)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border-l-4 border-green-500 pl-6">
                            ...
                            <div className="text-gray-300 space-y-3">
                                ...
                                <div className="bg-white/5 rounded-xl p-4 space-y-2 text-sm">
                                    ...
                                    <p><span className="text-white font-semibold">Manager Share =</span> 10% of positive Clean PnL only</p>
                        ...
                        <div className="border-l-4 border-yellow-500 pl-6">
                            <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                                3. Manager Profit Share (10%)
                            </h3>
                            <div className="text-gray-300 space-y-3">
                                <p>VIP Pool has a reduced profit share of 10% (vs 20% in other pools) to reward larger investors. Managers only earn from positive Clean PnL.</p>
                                <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                                    ...
                                    <ul className="space-y-1 text-sm">
                                        ...
                                        <li>• Distributed to investors: <span className="text-green-400 font-bold">$891</span></li>
                                    </ul>
                                </div>
                            ...
                            <div className="text-gray-300 space-y-3">
                                ...
                                <div className="bg-white/5 rounded-lg p-4 text-sm">
                                    ...
                                    <ul className="space-y-1">
                                        <li>• Jan 1: Pool has $100,000 from other investors</li>
                                        <li>• Jan 5: You deposit $50,000 → Your ownership: 33.3%</li>
                                        <li>• Jan 6: Trade wins $6,000 → You get 33.3% = $2,000 (after fees/share)</li>
                                        <li>• Jan 10: Another investor deposits $50,000 → Your ownership drops to 25%</li>
                                        <li>• Jan 15: Trade wins $8,000 → You get 25% = $2,000</li>
                                    </ul>
